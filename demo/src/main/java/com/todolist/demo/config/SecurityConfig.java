...
public class SecurityConfig {
    private final UserDetailsServiceImpl userDetailsServe;
    private final AuthenticationFilter authenticationFilter;
    private final AuthEntryPoint exceptionHandler;

    public SecurityConfig(UserDetailsServiceImpl userDetailsServe, AuthenticationFilter authenticationFilter, AuthEntryPoint exceptionHandler) {
        this.userDetailsServe = userDetailsServe;
    ...
    public AuthenticationManager authenticationManager(HttpSecurity http) throws Exception {
        ...
        authBuilder.userDetailsService(userDetailsServe).passwordEncoder(passwordEncoder());
